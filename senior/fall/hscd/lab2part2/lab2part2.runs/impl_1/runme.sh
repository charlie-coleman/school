...
HD_PWD='F:/school/2018-2019/fall/hscd/lab2part2/lab2part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_lights_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flash_lights_wrapper.tcl -notrace
