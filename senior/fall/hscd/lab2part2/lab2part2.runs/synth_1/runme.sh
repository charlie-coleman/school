...
HD_PWD='F:/school/2018-2019/fall/hscd/lab2part2/lab2part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flash_lights_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flash_lights_wrapper.tcl
