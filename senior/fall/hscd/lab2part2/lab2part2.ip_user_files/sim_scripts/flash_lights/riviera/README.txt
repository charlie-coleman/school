...
#
# Generated by export_simulation on Fri Oct 26 00:34:46 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './flash_lights.sh' script.

./flash_lights.sh -reset_run
...
./flash_lights.sh -noclean_files

For more information on the script, please type './flash_lights.sh -help'.
