...
--Command     : generate_target flash_lights_wrapper.bd
--Design      : flash_lights_wrapper
...
entity flash_lights_wrapper is
  port (
...
end flash_lights_wrapper;

architecture STRUCTURE of flash_lights_wrapper is
  component flash_lights is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
flash_lights_i: component flash_lights
     port map (
