...
HD_PWD='f:/school/2018-2019/fall/hscd/lab2part2/lab2part2.tmp/light_counter_v1_0_project/light_counter_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log light_counter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source light_counter_v1_0.tcl
