...
HD_PWD='F:/school/2018-2019/fall/hscd/lab2/lab2.runs/design_1_rw_reg_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rw_reg_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rw_reg_0_0.tcl
