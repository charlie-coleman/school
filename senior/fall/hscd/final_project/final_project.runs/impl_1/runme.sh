...
HD_PWD='F:/school/senior/fall/hscd/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_and_vga_out_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dma_and_vga_out_wrapper.tcl -notrace
