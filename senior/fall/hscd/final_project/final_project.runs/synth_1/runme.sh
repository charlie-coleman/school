...
HD_PWD='F:/school/senior/fall/hscd/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_and_vga_out_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_and_vga_out_wrapper.tcl
