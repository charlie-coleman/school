...
#
# Generated by export_simulation on Wed Nov 28 22:33:54 -0600 2018
#
################################################################################
...
'-reset_run' switch to the './dma_and_vga_out.sh' script.

./dma_and_vga_out.sh -reset_run
...
./dma_and_vga_out.sh -noclean_files

For more information on the script, please type './dma_and_vga_out.sh -help'.
